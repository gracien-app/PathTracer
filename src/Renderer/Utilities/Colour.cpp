...
void Colour::standardiseOutput(std::vector<std::uint8_t> &outPixels, const int &gridPos, const int &samples) {
...
void Colour::standardiseOutputPreview(std::vector<std::uint8_t> &outPixels, const int &gridPos) {
