...
public:
    ...
    void standardiseOutput(std::vector<std::uint8_t> &outPixels, const int &gridPos, const int &samples);
    
    void standardiseOutputPreview(std::vector<std::uint8_t> &outPixels, const int &gridPos);
