...
/// At the point of intersection, random non-negative (with respect to normal vector at the intersection point) unit vector is generated using
...
public:
    ...
    virtual bool reflect(const Ray &inputRay,
                               Ray &reflRay, const intersection &recInter, Colour &reflColour ) const override;
};
